...
import com.msl.pdfa.pdf.html.test.HTMLPrintableUtilTest;
...
public class TestUtil {
	...
	public static InputStream getInputHtml(){
		if(inputHtml == null){
			inputHtml = HTMLPrintableUtilTest.class.getClassLoader().getResourceAsStream(TestConstants.PDF_PATH + TestConstants.HTML_CONFIRMATION_PAGE);
		}
		return inputHtml;
	}
}
