 ...
 * @since 1.0.0
 */
public class OpenHtmlToPdfServiceException extends RuntimeException {
     ...
     */	
	public OpenHtmlToPdfServiceException(String message) {
		super(message);
	}
     ...
     */
    public OpenHtmlToPdfServiceException(Throwable cause) { super(cause); }
     ...
     *            permitted, and indicates that the cause is nonexistent or unknown.)
     */    
	public OpenHtmlToPdfServiceException(String message, Throwable cause) {
		super(message, cause);
	}
