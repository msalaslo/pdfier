...
public class PDFAGeneratorController
{
  ...
  public void pdfUAFromUrl(@RequestParam(value="url", required=true) String url, @RequestParam(value="fileName", required=false) String fileName, @RequestParam(value="inline", required=false) boolean inline, HttpServletRequest request, HttpServletResponse response) { try { if (url != null) {
  ...
  @RequestMapping(value={"/pdfuafromhtml"}, method={org.springframework.web.bind.annotation.RequestMethod.POST}, produces={"application/pdf"})
  @ResponseBody
