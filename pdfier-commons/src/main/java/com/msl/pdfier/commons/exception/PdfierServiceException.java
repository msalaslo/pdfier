 ...
 * @since 1.0.0
 */
public class PdfierServiceException extends RuntimeException {
     ...
     */	
	public PdfierServiceException(String message) {
		super(message);
	}
     ...
     */
    public PdfierServiceException(Throwable cause) { super(cause); }
     ...
     *            permitted, and indicates that the cause is nonexistent or unknown.)
     */    
	public PdfierServiceException(String message, Throwable cause) {
		super(message, cause);
	}
