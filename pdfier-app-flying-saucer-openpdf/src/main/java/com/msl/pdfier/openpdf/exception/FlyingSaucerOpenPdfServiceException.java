package com.msl.pdfier.openpdf.exception;
 ...
 * @since 1.0.0
 */
public class FlyingSaucerOpenPdfServiceException extends RuntimeException {
     ...
     */	
	public FlyingSaucerOpenPdfServiceException(String message) {
		super(message);
	}
     ...
     */
    public FlyingSaucerOpenPdfServiceException(Throwable cause) { super(cause); }
     ...
     *            permitted, and indicates that the cause is nonexistent or unknown.)
     */    
	public FlyingSaucerOpenPdfServiceException(String message, Throwable cause) {
		super(message, cause);
	}
